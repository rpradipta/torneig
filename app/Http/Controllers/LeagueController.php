...
class LeagueController extends Controller
{
    ...
    public function standings($id, $season)
    {
    ...
    $league = json_decode((Http::get('https://api-football-standings.azharimm.site/leagues/'.$id.'/standings?season='.$season))->body(),true);   
